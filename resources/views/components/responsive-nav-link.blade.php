...
$classes = ($active ?? false)
            ? 'block w-full px-4 py-3 text-start text-base font-black text-gray-900 bg-accent border-4 border-black rounded-xl shadow-neo-sm translate-x-[2px] translate-y-[2px] shadow-neo-active focus:outline-none transition-all'
