<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto py-8">
        <div class="brutal-box bg-white p-8 md:p-12 text-center">
            <div class="inline-flex items-center justify-center w-20 h-20 mb-6 border-4 border-border rounded-full shadow-[6px_6px_0px_0px_#000] bg-pastel-lemon">
            ...
            <div class="brutal-box bg-pastel-sky p-5 mb-8 text-left">
