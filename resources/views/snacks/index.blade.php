    ...
    <div x-data="snacksComponent" class="relative min-h-screen pb-32">
        ...
        <section class="relative bg-pastel-peach border-[3px] border-border rounded-[2rem] p-8 md:p-14 shadow-[8px_8px_0px_rgba(0,0,0,1)] overflow-hidden flex flex-col md:flex-row gap-12 items-center mb-16">
            ...
            <div class="flex-1 relative z-10 w-full">
                ...
                <p class="font-bold border-l-4 border-foreground pl-4 opacity-90 text-base md:text-lg max-w-md">
                    Pre-order popcorn & minumanmu. Langsung ambil di jalur khusus tanpa antre!
                </p>
            </div>

            <div class="relative z-10 flex items-center justify-center w-full md:w-auto mt-10 md:mt-0 h-64 md:h-auto select-none">
        ...
        <section class="grid md:grid-cols-2 gap-6 mb-16">
            <div class="brutal-card p-6 md:p-8 bg-pastel-lemon flex flex-col md:flex-row items-start md:items-center gap-6 cursor-pointer rounded-[2rem] border-4 hover:-translate-y-2 transform -rotate-1 shadow-[6px_6px_0px_var(--border)]"
                ...
                <div>
                    ...
                    <h4 class="text-xl md:text-2xl mb-1">Gratis Upsize Minuman!</h4>
                    <p class="font-bold opacity-75 text-sm mb-3">
            ...
            <div class="brutal-card p-6 md:p-8 bg-pastel-sky flex flex-col md:flex-row items-start md:items-center gap-6 cursor-pointer rounded-[2rem] border-4 hover:-translate-y-2 transform rotate-1 shadow-[6px_6px_0px_var(--border)]"
                ...
                <div>
                    ...
                    <h4 class="text-xl md:text-2xl mb-1">Cashback QRIS 20%</h4>
                    <p class="font-bold opacity-75 text-sm mb-3">
        ...
        <section class="bg-white border-4 border-border rounded-[2rem] p-8 shadow-[8px_8px_0px_rgba(0,0,0,1)] relative mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
                <div class="flex flex-col gap-3">
                    <x-icon name="heroicon-s-shopping-bag" class="w-12 h-12 text-border select-none" />
                    <h4 class="text-lg font-black uppercase tracking-tight">1. Pesan Online</h4>
                    <p class="text-sm font-medium opacity-80">
                        Masukkan ke keranjang bareng tiket atau pesan terpisah sebelum film mulai.
                    </p>
                </div>
                <div class="flex flex-col gap-3">
                    <x-icon name="heroicon-s-phone" class="w-12 h-12 text-border select-none" />
                    <h4 class="text-lg font-black uppercase tracking-tight">2. Scan QR Code</h4>
                    <p class="text-sm font-medium opacity-80">
                        Tunjukkan QR E-Ticket F&B kamu di layar ke petugas Ticketra Fast Lane.
                    </p>
                </div>
                <div class="flex flex-col gap-3">
                    <x-icon name="heroicon-s-ticket" class="w-12 h-12 text-border select-none" />
                    <h4 class="text-lg font-black uppercase tracking-tight">3. Langsung Ngunyah</h4>
                    <p class="text-sm font-medium opacity-80">
        ...
        <section id="katalog" class="mb-16">
            <div class="flex items-center justify-between mb-8">
                <h2 class="text-3xl md:text-4xl uppercase tracking-tight">Katalog Menu</h2>
            </div>

            
            <div class="flex flex-col md:flex-row items-center justify-between gap-6 border-b-4 border-border/20 pb-8 mb-8">
                <div class="flex items-center gap-3 overflow-x-auto w-full md:w-auto hide-scrollbar pb-2">
                ...
                <template x-for="(item, index) in sortedItems" :key="'desk-'+item.id">
                    <div class="brutal-card p-6 bg-white flex relative overflow-hidden rounded-[2rem] border-4 shadow-[6px_6px_0px_var(--border)]"
                        ...
                        <template x-if="index === 0">
                            <div class="flex-1 flex flex-col md:flex-row gap-6 relative z-10 p-2 justify-between items-stretch">
                                ...
                                <div class="flex-1 flex flex-col justify-between py-2">
                                    <div>
                                        ...
                                        <div class="border-l-[3px] border-black pl-4 mb-6">
                                            <p class="font-bold opacity-80 text-sm md:text-base text-gray-700 leading-relaxed" x-text="item.desc"></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-auto flex flex-col gap-4">
                                        ...
                                        <div class="border-[3px] border-black bg-white px-5 py-2.5 shadow-[4px_4px_0px_rgba(0,0,0,1)] w-max">
                                            <p class="font-price font-black text-2xl text-black">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <template x-if="getItemQty(item.id) > 0">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span class="w-12 text-center font-price font-black text-2xl" x-text="getItemQty(item.id)"></span>
                        ...
                        <template x-if="index !== 0">
                            <div class="flex-1 flex flex-col relative z-10 justify-between">
                                ...
                                <div class="flex flex-col pt-5 shrink-0 h-auto">
                                    <span class="text-[10px] font-bold opacity-60 uppercase tracking-widest mb-1" x-text="item.category"></span>
                                    <h4 class="font-heading font-extrabold text-lg leading-tight mb-3 uppercase" x-text="item.name"></h4>

                                    <div class="flex items-center gap-2 mb-4 border-l-2 border-gray-400 pl-3">
                                        <p class="font-price font-black text-foreground text-xl">
                                            Rp <span x-text="item.price.toLocaleString('id-ID')"></span>
                                        </p>
                                    </div>

                                    <div class="flex items-center gap-2 mt-auto border-t-2 border-border/20 pt-4">
                                        <template x-if="getItemQty(item.id) > 0">
                                            <div class="flex items-center gap-2 w-full">
                                                ...
                                                <span class="flex-1 text-center font-price font-black text-2xl" x-text="getItemQty(item.id)"></span>
            ...
            <div class="md:hidden flex flex-col gap-8">
                ...
                <template x-if="sortedItems.length > 0">
                    <div class="brutal-card p-6 bg-white border-4 flex flex-col gap-5 rounded-[2rem] relative shadow-[6px_6px_0px_var(--border)]" :class="sortedItems[0].status === 'HABIS' ? 'disabled-card' : ''">
                        ...
                        <div>
                            ...
                            <p class="font-bold opacity-80 text-xs border-l-4 border-border pl-2" x-text="sortedItems[0].desc"></p>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-2">
                            <div class="inline-block bg-white px-2 py-1 transform -skew-x-6 border-2 border-border shadow-[2px_2px_0px_var(--border)]">
                                <p class="font-price font-black text-2xl text-foreground transform skew-x-6">
                            ...
                            <div class="flex items-center gap-2 w-full sm:w-auto">
                                <template x-if="getItemQty(sortedItems[0].id) > 0">
                                    <div class="flex items-center gap-2 w-full">
                                        ...
                                        <span class="flex-1 text-center font-price font-black text-2xl" x-text="getItemQty(sortedItems[0].id)"></span>
                ...
                <template x-if="sortedItems.length > 1">
                    <div class="flex gap-4 overflow-x-auto snap-x hide-scrollbar pb-6 pt-2 px-1">
                        <template x-for="item in sortedItems.slice(1)" :key="'mob-'+item.id">
                            <div class="min-w-[260px] snap-start flex-shrink-0">
                                <div class="brutal-card p-5 bg-white flex flex-col h-full rounded-[1.5rem] border-2 shadow-[4px_4px_0px_var(--border)]" :class="item.status === 'HABIS' ? 'disabled-card' : ''">
                                    ...
                                    <div class="flex flex-col pt-5 flex-1 justify-between">
                                        <div>
                                            <span class="text-[10px] font-bold opacity-60 uppercase tracking-widest mb-1 block" x-text="item.category"></span>
                                            <h4 class="font-heading font-extrabold text-lg leading-tight mb-2 uppercase" x-text="item.name"></h4>
                                            <p class="font-price font-black text-foreground text-xl mt-auto mb-4 border-l-4 border-border pl-2">
                                                Rp <span x-text="item.price.toLocaleString('id-ID')"></span>
                                            </p>
                                        </div>
                                        ...
                                        <div class="flex items-center gap-2 mt-auto border-t-2 border-border/20 pt-4">
                                            <template x-if="getItemQty(item.id) > 0">
                                                <div class="flex items-center gap-2 w-full">
                                                    ...
                                                    <span class="flex-1 text-center font-price font-black text-xl" x-text="getItemQty(item.id)"></span>
                                            ...
                                            <template x-if="getItemQty(item.id) === 0">
                                                <button @click="updateCart(item, 1)" :disabled="item.status === 'HABIS'" class="brutal-btn w-full !py-3 !text-sm shadow-[2px_2px_0px_var(--border)] bg-white hover:bg-main hover:text-white uppercase tracking-widest text-foreground">
                                                    Tambah
                                                </button>
                                            </template>
                                        </div>
            ...
            <div x-show="sortedItems.length === 0"
                ...
                style="display: none;">
                <div class="w-20 h-20 bg-pastel-sky border-4 border-border rounded-full flex items-center justify-center mx-auto mb-4 text-4xl transform rotate-12 shadow-[3px_3px_0px_var(--border)]">🔍</div>
                <h3 class="text-3xl mb-2 font-heading font-black uppercase tracking-tight">Ups, Menu Gak Ketemu</h3>
                <p class="font-medium opacity-70 text-lg">Coba ubah filter kategori atau kata kunci pencarian Anda.</p>
            </div>
        </section>
        ...
        <div x-show="totalCartItems > 0"
            ...
            <div class="bg-foreground border-4 border-border rounded-3xl p-4 md:p-5 shadow-[8px_8px_0px_rgba(0,0,0,1)] flex items-center justify-between">
                ...
                <button @click="checkoutCart" class="brutal-btn bg-pastel-lemon text-foreground !py-3.5 !px-8 shadow-[3px_3px_0px_var(--border)] text-lg">
                    Checkout <x-icon name="heroicon-s-arrow-right" class="w-5 h-5 text-foreground" />
                </button>
            </div>
        </div>
